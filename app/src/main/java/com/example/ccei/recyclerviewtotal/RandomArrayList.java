...
public class RandomArrayList {
    ...
    static {
        ...
        nameMaps.put(R.drawable.girls_eneration_all, "소녀시대 멤버1");
        ...
        nameMaps.put(R.drawable.girls_generation_all, "소녀시대 멤버2");
        ...
        nameMaps.put(R.drawable.girls_generation_sunny, "서니2");
    ...
    public static ArrayList<Integer> getShuffleArrayList(){
